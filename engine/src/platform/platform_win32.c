...
b8 platform_startup(
    ...
    wc.hbrBackground = NULL;                  // Tansparent
    wc.lpszClassName = "rouge_window_class";
    ...
    HWND handle = CreateWindowExA(
        window_ex_style, "rouge_window_class", application_name,
    ...
    // Show the window
    b32 should_active = 1; // TODO: if the window should not accept input, this should be false.
...
b8 platform_create_vulkan_surface(platform_state* plat_state, vulkan_context* context) {
    ...
    if (result != VK_SUCCESS) {
        RFATAL("Vulkan surface creation failed!");
        return FALSE;
    }
