...
void event_shutdown(void) {
    // Free the events arrays. And objects printed to should be destroyed on their own.
...
b8 event_register(u16 code, void* listener, PFN_on_event on_event) {
    ...
    // If a this point, no duplicate was found. Proceed with registration.
