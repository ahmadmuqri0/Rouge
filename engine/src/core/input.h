...
// Keyboard input
RAPI b8 input_is_key_down(keys key);
RAPI b8 input_is_key_up(keys key);
RAPI b8 input_was_key_down(keys key);
RAPI b8 input_was_key_up(keys key);

void input_process_key(keys key, b8 pressed);

RAPI b8 input_is_button_down(buttons button);
RAPI b8 input_is_button_up(buttons button);
RAPI b8 input_was_button_down(buttons button);
RAPI b8 input_was_button_up(buttons button);
